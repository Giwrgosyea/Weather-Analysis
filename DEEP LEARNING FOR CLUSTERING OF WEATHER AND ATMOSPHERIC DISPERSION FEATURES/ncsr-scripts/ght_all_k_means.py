# Run: kmeans.py <GHT_ALL.npz> <PREFIX> <model> <concat or avg> ||python2 kmeans.py ../GHT_all.npz  /workspace/products/raw_kmeans/ model avg
import sys
...
# if lat == 'concat':
#     print('last layer concat')
#     model = Model(inputs=model.inputs, outputs=model.get_layer("concat").output)
# else:
